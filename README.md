...
>  >    
>  >    round는 총 4개로, 1라운드에선 두더지가 0.8초만에 들어가고, 각각 라운드 마다 머무는 시간이 0.2초씩 짧아진다.   
>  >    두더지가 나오지 않은 구멍을 때리면 두더지가 바로 숨어버린다.   
>  >    그외에 잘못된 키를 누르면 1라운드에선 0.3초 더 기다려주며, 그 뒤로는 기다려주는 시간이 0.05초씩 줄어든다.
>  >  
>  >* 점수   
>  >    정상적으로 두더지를 잡으면 10점   
...
>  >  
>  >* 라운드 진행   
>  >    1,2 round에서는 각 라운드에서의 결과와 관계없이 총 획득가능한 점수의 80% 이상을 획득해야 다음 라운드로 넘어간다.   
>  >    *`ex) 1라운드: 총점 80점 이상, 2라운드: 총점 160점 이상`*   
>  >    4라운드는 히든 라운드로 3라운드까지의 모든 두더지를 잡으면 4라운드로 넘어갈 수 있다.   
